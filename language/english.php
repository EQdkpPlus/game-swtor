...
$english_array =  array(
	...
	'lang' => array(
		...
		'ruf21'	=> 'Underworld Exchange',
		'ruf22'	=> 'Republic Forces on Iokath',
		'ruf23'	=> 'OSSUS Assault Battalion',
		...
		'hc_ewigekammer'					=> 'The Eternity Vault (Veteran)',
		'nm_ewigekammer'					=> 'The Eternity Vault (Master)',
		'sm_karaggaspalast'					=> 'Karaggas Palace (Story)',
		'hc_karaggaspalast'					=> 'Karaggas Palace (Veteran)',
		'nm_karaggaspalast'					=> 'Karaggas Palace (Master)',
		'sm_explosivkonflikt'				=> 'Explosiv Conflict (Story)',
		'hc_explosivkonflikt'				=> 'Explosiv Conflict (Veteran)',
		'nm_explosivkonflikt'				=> 'Explosiv Conflict (Master)',
		'sm_abschaum'						=> 'Scum and Villainy (Story)',
		'hc_abschaum'						=> 'Scum and Villainy (Veteran)',
		'nm_abschaum'						=> 'Scum and Villainy (Master)',
		'sm_schrecken'						=> 'Terror from Beyond (Story)',
		'hc_schrecken'						=> 'Terror from Beyond (Veteran)',
		'nm_schrecken'						=> 'Terror from Beyond (Master)',
		'sm_s_festung'						=> 'Dread Fortress (Story)',
		'hc_s_festung'						=> 'Dread Fortress (Veteran)',
		'nm_s_festung'						=> 'Dread Fortress (Master)',
		'sm_s_palast'						=> 'Dread Palace (Story)',
		'hc_s_palast'						=> 'Dread Palace (Veteran)',
		'nm_s_palast'						=> 'Dread Palace (Master)',
		'sm_tbh'							=> 'Golden Fury (Story)',
		'hc_tbh'							=> 'Golden Fury (Veteran)',
		'nm_tbh'							=> 'Golden Fury (Master)',
		'sm_wueter'							=> 'The Ravagers (Story)',
		'hc_wueter'							=> 'The Ravagers (Veteran)',
		'nm_wueter'							=> 'The Ravagers (Master)',
		'sm_tempel'							=> 'Tempel of Sacrifice (Story)',
		'hc_tempel'							=> 'Tempel of Sacrifice (Veteran)',
		'nm_tempel'							=> 'Tempel of Sacrifice (Master)',
