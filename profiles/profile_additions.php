	...
	");
		...
		$a_professions = array(
			0	=> array(
				...
				'progressbar'	=> $this->jquery->progressbar('profession1', 0, array('completed' => $member['prof1_value'], 'total' => 700, 'text' => '%progress%'))
			),
			1	=> array(
				...
				'progressbar'	=> $this->jquery->progressbar('profession2', 0, array('completed' => $member['prof2_value'], 'total' => 700, 'text' => '%progress%'))
			),
			2	=> array(
				...
				'progressbar'	=> $this->jquery->progressbar('profession3', 0, array('completed' => $member['prof3_value'], 'total' => 700, 'text' => '%progress%'))
			)
		);
